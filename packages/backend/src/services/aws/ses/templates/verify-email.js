                              ...
                              <tbody>
                                <tr>
                                  <td valign="top" style="padding:54px;text-align:left;color:#151516;font-size:12px;font-family:&quot;Lucida Sans Unicode&quot;,&quot;Lucida Grande&quot;,sans-serif;word-break:break-word;direction:ltr;box-sizing:border-box">
                                    ...
                                    <p style="margin:0px;padding:0px"><span style="font-size:14px"><B>Hey ${name}!</B><br><br></span></p>
                                    <p style="margin:0px;padding:0px"><span style="font-size:14px">
                                    You're almost ready to start learning and building projects. Please click the below button to confirm your registration and to proceed.
                                    </span></p>
                                    <br>
                                    </p>
                                    <p style="margin-left:25%;padding:0px"><a href="${link}" style=""  target="_blank" data-saferedirecturl=""><button class="button"><strong>Verify Email</strong></button>
                                      </a>
                                      </strong>
                                    </p>
